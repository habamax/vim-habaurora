...
" Last Updated: 10.04.2022 12:17:26
...
hi TabLineSel guifg=#262626 guibg=#e4e4e4 gui=NONE cterm=NONE
...
hi CurSearch guifg=#e4e4e4 guibg=#875f00 gui=NONE cterm=NONE
...
hi Cursor guifg=#d7005f guibg=#e4e4e4 gui=reverse cterm=reverse
hi lCursor guifg=#0000ff guibg=#262626 gui=reverse cterm=reverse
...
hi StatuslineTermNC guifg=#e4e4e4 guibg=#949494 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi CurSearch ctermfg=254 ctermbg=94 cterm=NONE
  ...
  hi StatuslineTermNC ctermfg=254 ctermbg=246 cterm=NONE
...
" Color: colorV        #B3D0E7        67             darkcyan
